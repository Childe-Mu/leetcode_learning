...
// 👍 228 👎 0
public class No1101_shipWithinDays {
    public static void main(String[] args) {
        System.out.println(new No1101_shipWithinDays().shipWithinDays_v1(new int[]{3, 2, 2, 4, 1, 4}, 3));
    }

//    public int shipWithinDays_v2(int[] weights, int D) {
