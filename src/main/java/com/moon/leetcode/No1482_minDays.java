...
// 👍 164 👎 0
public class No1482_minDays {
    public int minDays_v1(int[] bloomDay, int m, int k) {
    ...
    public int minDays_v2(int[] bloomDay, int m, int k) {
        int n = bloomDay.length;
        if (n < m * k) {
            return -1;
        }
    ...
    public static void main(String[] args) {
        System.out.println(new No1482_minDays().minDays_v2(new int[]{1, 10, 2, 9, 3, 8, 4, 7, 5, 6}, 4, 2));
    }
}
